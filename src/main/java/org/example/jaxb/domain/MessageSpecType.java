...
/**
 * Type for message specification. Identifies the Financial Institution (FI), or Tax Administration or third-party vendor sending a message.  It specifies the date created, reporting year, and the nature of the report (original, corrected, amended, etc.).
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="SendingCompanyIN" type="{urn:oecd:ties:stffatcatypes:v2}StringMax200_Type" minOccurs="0"/>
 ...
 *         &lt;element name="MessageType" type="{urn:oecd:ties:stffatcatypes:v2}MessageType_EnumType"/>
 *         &lt;element name="Warning" type="{urn:oecd:ties:stffatcatypes:v2}StringMax4000_Type" minOccurs="0"/>
 *         &lt;element name="Contact" type="{urn:oecd:ties:stffatcatypes:v2}StringMax200_Type" minOccurs="0"/>
 *         &lt;element name="MessageRefId" type="{urn:oecd:ties:stffatcatypes:v2}StringMax200_Type"/>
 *         &lt;element name="CorrMessageRefId" type="{urn:oecd:ties:stffatcatypes:v2}StringMax200_Type" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "MessageSpec_Type", namespace = "urn:oecd:ties:stffatcatypes:v2", propOrder = {
    "sendingCompanyIN",
    "transmittingCountry",
    "receivingCountry",
    "messageType",
