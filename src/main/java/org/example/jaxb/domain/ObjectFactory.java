...
public class ObjectFactory {
    ...
    private final static QName _AddressTypeCountryCode_QNAME = new QName("urn:oecd:ties:stffatcatypes:v2", "CountryCode");
    private final static QName _AddressTypeAddressFree_QNAME = new QName("urn:oecd:ties:stffatcatypes:v2", "AddressFree");
    private final static QName _AddressTypeAddressFix_QNAME = new QName("urn:oecd:ties:stffatcatypes:v2", "AddressFix");
    ...
    /**
     * Create an instance of {@link CorrectableReportOrganisationType }
     * 
     */
    public CorrectableReportOrganisationType createCorrectableReportOrganisationType() {
        return new CorrectableReportOrganisationType();
    }

    /**
     * Create an instance of {@link CARRefType }
     * 
     */
    public CARRefType createCARRefType() {
        return new CARRefType();
    }
    ...
    /**
     * Create an instance of {@link SubstantialOwnerType }
     * 
     */
    public SubstantialOwnerType createSubstantialOwnerType() {
        return new SubstantialOwnerType();
    }
    ...
    /**
     * Create an instance of {@link CorrectableNilReportType }
     * 
     */
    public CorrectableNilReportType createCorrectableNilReportType() {
        return new CorrectableNilReportType();
    }
    ...
    /**
     * Create an instance of {@link AdditionalDataType.AdditionalItem }
     * 
     */
    public AdditionalDataType.AdditionalItem createAdditionalDataTypeAdditionalItem() {
        return new AdditionalDataType.AdditionalItem();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:oecd:ties:stffatcatypes:v2", name = "CountryCode", scope = AddressType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:oecd:ties:stffatcatypes:v2", name = "AddressFree", scope = AddressType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:oecd:ties:stffatcatypes:v2", name = "AddressFix", scope = AddressType.class)
